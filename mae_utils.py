...
def get_2d_sincos_pos_embed(embed_dim, grid_size, cls_token=False, add_token=False, shift_token=False):
    """
    grid_size: int of the grid height and width
    return:
    pos_embed: [grid_size*grid_size, embed_dim] or [1+grid_size*grid_size, embed_dim] (w/ or w/o cls_token) or [2+grid_size*grid_size, embed_dim] (w/ or w/o shift_token)
    """
    H = W = grid_size
    ...
    if shift_token:
        ...
        """Deprecated"""
        pos_embed = np.concatenate([np.zeros([grid_size**2, embed_dim]), pos_embed], axis=0)
    return pos_embed
